...
<p style="display: flex; gap: 20px;">
	...
	<img src="https://icomp.ufam.edu.br/images/icomp.png" height="80" alt="Instagram"> </a>
</p>

## About Me

Altigran Soares da Silva is a Full Professor at the Institute of Computing of the Federal University of Amazonas (IComp/UFAM), a CNPq Level A Researcher, and a Full Member of the Brazilian Academy of Sciences (ABC). He earned his Ph.D. in Computer Science from the Federal University of Minas Gerais (UFMG) in 2002. His research focuses on Data Science, Data Management, and Information Retrieval, including Data Mining, Machine Learning, and Large Language Models. He has coordinated and participated in dozens of research projects, resulting in more than 170 scientific publications in journals and conference proceedings. He has extensive experience in scientific committees, having chaired program committees of conferences in Brazil and abroad and served as a program committee member in approximately 70 international conferences and workshops. He served as Vice President for Research and Graduate Studies at UFAM from 2007 to 2009. He has acted on the CNPq Computer Science Advisory Committee as chair (2023/2024) and as a member in different terms (2016/2019 and 2021/2024). He was Deputy Coordinator of the Computer Science area at CAPES (2011/2013), a member of the board of directors (2005/2015) and of the council (2016/2019) of the Brazilian Computer Society (SBC), as well as a member of the Higher Council of FAPEAM (2021/2023). He is currently a member of the Monitoring and Evaluation Committee of the RNP/MCTI Management Contract, a member of the SBC council, Deputy Coordinator for professional programs in Computer Science at CAPES, Editor-in-Chief of the Journal of the Brazilian Computer Society and Latin America Caribbean Regional Committee Chair of the ACM Globalization Board. He also has a strong track record in technological entrepreneurship, being a co-founder of Akwan, acquired by Google in 2005, Neemu, acquired by Linx Systems in 2015, and Teewa, acquired by JusBrasil in 2019. He also works in cooperation with technology companies, with emphasis on applied research in partnership with JusBrasil (since 2022) and on his role as a scientific and technological consultant to Méliuz (2016/2020). In 2013, a Ph.D. dissertation under his supervision received first place in the SBC Thesis and Dissertation Award and an Honorable Mention in the CAPES Thesis Award. In the same year, he received the SBC Distinguished Member Award. In 2015, he received a Google Research Award in Latin America as an advisor. 
...
### Journal Papers
- [Vianna@AIL24] Daniela Vianna, Edleno Silva de Moura, Altigran S. da Silva: [**A topic discovery approach for unsupervised organization of legal document collections.**](https://link.springer.com/article/10.1007/s10506-023-09371-w) Artif. Intell. Law 32(4): 1045-1074 (2024)🎙️[Podcast-PT](https://drive.google.com/open?id=1BVBkjGDcFCScatJnTrq84plFIPLGu7R3&usp=drive_fs) 🎙️[Podcast-ENG](https://drive.google.com/open?id=1BWgy2Unq4UgDca-RmJ3fGk8I0BFzLd0q&usp=drive_fs) 
...
- [**CIIA-Saúde - Center for Innovation in Artificial Intelligence for Health (Centro de Inovação em Inteligência Artificial para a Saúde)**](https://ciia-saude.dcc.ufmg.br/) - Principal Investigator - A multidisciplinary project exploring AI-driven solutions to enhance diagnostics, treatment plans, and healthcare management - Funded by FAPESP/MCTI, FAPEMIG, and UNIMED-BH
- [**IAIA - National Institute of Science and Technology in Artificial Intelligence (Instituto Nacional de Ciência e Tecnologia em Inteligência Artificial)** ](https://inct-iaia.vercel.app/)- Steering Committee Member - National initiative aiming to advance AI technologies across multiple domains, fostering innovation and collaboration - Funded by CNPq
...
- [Duarte'24] **Aline Duarte** - Um Estudo sobre o uso de Modelos de Linguagem de Larga Escala para An´alise de Dados Acadêmicos da Pós-Graduação (A Study on the Use of Large Scale Language Models for Analysis of Postgraduate Academic Data). 
  🎙️[Posdcast-PT](https://drive.google.com/file/d/1AbVtVEaycw4I9L3ddOdfnT6A1f12tRPt/view?pli=1)  🎙️[Podcast-EN](https://drive.google.com/open?id=1AbVtVEaycw4I9L3ddOdfnT6A1f12tRPt&usp=drive_fs)
 
---

## Experimental Datasets Available
- [Schema Matching Network Datasets](https://github.com/diego-rodrigues/schema-matching-datasets). This repository contains a collection of datasets related to the database schema matching problem. The datasets can be used to evaluate and compare different schema matching techniques, particularly in scenarios involving multiple schemas. Suitable for experiments in data integration, machine learning, and networked schema reconciliation. It was originally used in Diego Rodrigues, Altigran S. da Silva: A study on machine learning techniques for the schema matching network problem. [J. Braz. Comput. Soc. 27(1): 14 (2021)](https://journal-bcs.springeropen.com/articles/10.1186/s13173-021-00119-5)
